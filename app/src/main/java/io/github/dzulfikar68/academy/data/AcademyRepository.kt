...
import io.github.dzulfikar68.academy.data.source.local.entity.ContentEntity
...
import io.github.dzulfikar68.academy.data.source.remote.response.ContentResponse
import io.github.dzulfikar68.academy.data.source.remote.response.CourseResponse
import io.github.dzulfikar68.academy.data.source.remote.response.ModuleResponse

class AcademyRepository constructor(private val remoteDataSource: RemoteDataSource) :
    AcademyDataSource {
